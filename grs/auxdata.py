...
NDWI_nir_threshold = [-0.03, 1.0]
NDWI_swir_threshold = [0.12, 2.0]
...
sunglint_eps_file = files("grs.data.aux").joinpath(
...
class AuxData:
    ...
    def __init__(self, wl=None):
        ...
        self.sunglint_eps = pd.read_csv(
            sunglint_eps_file, sep="\s+", index_col=0
        ).to_xarray()
        self.rayleigh()
    ...
    def __init__(self, sensor):
        ...
        InfoSat = {
            ...
            "LANDSAT_4": {
                ...
                "vza_name": "Zenith_",
                "azi_name": "Azimuth_",
                "ang_proc": os.path.join(
                    cfg.grs_root, "landsat_angles/TM/landsat_angles"
                ),
        ...
        self.NDWI_swir_nir, self.NDWI_swir_swir, self.NDWI_swir_threshold = info[
            "ndwi_swir_conf"
        ]
