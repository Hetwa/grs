...
class L2aProduct:
    ...
    def construct_l2a(self):
        ...
        transmittance_raster = self.gas_trans.Tg_tot_coarse.rename(
            {"x": "xc", "y": "yc", "wl": "wl_all"}
        )
    ...
    def export_to_netcdf(self, output_path, snap_compliant=False):
        ...
        self.l2_prod.to_netcdf(ofile + ".nc", encoding=encoding, engine="netcdf4")
        ...
        self.ancillary.to_netcdf(
            ofile + "_anc.nc", "w", encoding=encoding, engine="netcdf4"
        )  # ,group='ancillary')
